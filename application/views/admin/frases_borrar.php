	...
	<div id="contenido">
	    ...
	    <table width="100%" align="center">
			<? foreach ($frase as $row) { ?>
				<form action="<?=base_url()?>index.php/admin/admin/frase_borrar" method="post">
				...
				<tr>
					<td align="center"><input type="submit" value="borrar frase" name="enviar" class="boton_form"/></td>
				</tr>
				</form>
			<? } ?>
		</table>
