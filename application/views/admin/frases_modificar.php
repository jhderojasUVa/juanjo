...
<div id="centrado">
	<div id="contenido">
	    ...
	    <table width="100%" align="center">
			<? foreach ($frase as $row) { ?>
				<form action="<?=base_url()?>index.php/admin/admin/frase_modificar" method="post">
				<input type="hidden" value="1" name="modificar" />
				<input type="hidden" value="<?=$row -> idfrase?>" name="idfrase" />
				<tr>
					<td><input type="text" name="frase" value="<?=$row -> frase?>" placeholder="frase" style="width:840px;"/></td>
				</tr>
				<tr>
					<td align="center"><input type="submit" value="cambiar frase" name="enviar" class="boton_form"/></td>
				</tr>
				</form>
			<? } ?>
		</table>
